...
[Home](./index.md) &gt; [dropdown-menu](./dropdown-menu.md) &gt; [DropdownToggleContextType](./dropdown-menu.dropdowntogglecontexttype.md)
...
```
**References:** [RequestOpenChangeOptions](./dropdown-menu.requestopenchangeoptions.md)
