...
[Home](./index.md) &gt; [dropdown-menu](./dropdown-menu.md) &gt; [DropdownOpenContext](./dropdown-menu.dropdownopencontext.md)

## DropdownOpenContext variable
...
```typescript
DropdownOpenContext: import("react").Context<Readonly<{
    isOpen: boolean;
}>>
```
