...
/**
 * An imperative handle for the {@link Dropdown} component that allows
...
/**
 * The base props for the {@link Dropdown} component, which are shared
...
/**
 * Props for the `Dropdown` component when the open state is controlled
...
export type DropdownProps =
    | DropdownPropsInternallyControlled
    | DropdownPropsExternallyControlled;

// doc comments are on the exported `Dropdown` component at the bottom so
// that they are visible in the docs
const _Dropdown = memo(function DropdownMemo(
    props: DropdownProps
): JSX.Element {
    ...
    useImperativeHandle(handle, (): DropdownHandle => ({
        openSubmenu,
        closeSubmenu,
 ...
 * @public
 */
export const Dropdown = _Dropdown as
